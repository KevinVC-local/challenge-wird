...
import { UserForm, UserInfo } from '../../core/models/user.model';
...
const Login = () => {
    ...
    const { handleSubmit, errors, touched, getFieldProps } = useFormik({
        ...
        validationSchema: Yup.object({
            email: Yup.string()
                .required('Required')
                .matches(regexEmail, 'It is not a valid email format'),
            password: Yup.string()
    ...
    const login = async (values: UserForm) => {
        try {
            console.log(values);
            ...
            dispatch(createUser({ ...newUser, rol: roleUser }));
    ...
    const onChangeCheckbox = (status: React.ChangeEvent<HTMLInputElement>) => {
        setCheckedAdmin(status.target.checked);
    }
        ...
        <div className="h-screen flex justify-center items-center bg-white dark:bg-boxdark">
            <div className="flex items-center w-5/6 md:w-4/6 rounded-xl border border-stroke shadow-default dark:border-strokedark ">
                ...
                <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                    <div className="w-full p-4 sm:p-4 xl:p-5 flex flex-col items-center">

                        <form noValidate onSubmit={handleSubmit} className='w-full px-4'>
                            <div className="mb-4">
                                <label htmlFor='email' className="mb-1 block font-medium text-black dark:text-white">
                                    Email
                                </label>
                                <div className="relative">
                                    <CustomInput placeholder="Email" type="email" {...getFieldProps('email')}  />
                            ...
                            <div className="mb-6">
                                ...
                                <div className="relative">
                                    <CustomInput placeholder="Password" type="password" {...getFieldProps('password')}  />
                            ...
                            <div className="mb-5">
                                <button
                                    type="submit"
                                    className="w-full cursor-pointer rounded-lg border border-secondary2 bg-secondary2 p-2 text-white transition hover:bg-opacity-90"
                                >Sign In</button>
                            </div>
                        </form>
                        <div className='flex'>
                            <input type="checkbox" name="check-inpit" id="" checked={checkedAdmin} onChange={(e) => onChangeCheckbox(e)} />
                            <p className="flex items-center">Administrator type user</p>
                        </div>


                        <div className="mt-6 text-center">
                            <p>
                                Don’t have any account? <span className='mb-2'>
                                    <Link to="/register" className="text-primary2">
                                        Sign Up
                                    </Link>
                                </span>
                            </p>
